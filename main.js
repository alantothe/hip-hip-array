...
let students = [
  ...
  // Challenge 2
  // Loop through the following array BACKWARDS, console.logging out each value. 64 
  //should be printed first and 100 last.
...
console.log(mixedSignNumbers)  
  ...
  for (i=0;i<=fibonacciNumbers.length-1; i++){
...
for (i=0 ; i <=alanArray.length-1 ;i++)
console.log(alanArray[i])
  ...
  // Challenge 8
  // Make a new EMPTY array and fill it with five values of your choice using BOTH .push AND .unshift, and 
  //then console.log out each value individually.
  const emptyArray = [];
  // Challenge 8 Code

  emptyArray.unshift("byun")
  emptyArray.unshift("maru")
  emptyArray.unshift("clem")
  emptyArray.push("heromarine")
  emptyArray.push("gumiho")
  ...
  // Challenge 9
  // Loop through the `students` array from Challenge 1, starting 
  //at index 3 and ending at index 10 (INCLUSIVE), 
...
console.log(students[i])
  ...
  // Challenge 10
  // Loop through the `students` array from Challenge 1, making a COPY of the array , starting at 
  //index 3 and ending at index 10 (INCLUSIVE). 
  //This is very similar 
  //to string building; create a new array, loop through the old one, and put values from the original 
  //in the new one. Then log out each value of the copy indivudally.
...
fillArray.push(students)


for(i=0; i<=fillArray.length-1;i++){
...
console.log(dinosaurs[i])
  ...
  // Challenge 13
  // Use .join to change the dinosaur strings from the above array into one string with a '*' string as the 
  ...
  // Then console.log out each value of that new array individually. Now console.log both the primaries 
  //and secondaries arrays, noting that .concat does NOT mutate the original arrays.
  // Challenge 15 Code

  allElements = dinosaurs.concat(students)
